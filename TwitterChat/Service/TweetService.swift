...
struct TweetService {
    ...
    func fetchTweets(completion: @escaping([Tweet]) -> Void ) {
        Firestore.firestore().collection("tweets").order(by: "timestamp").getDocuments { snapshot, _ in
    ...
    func fetchProfileUserTweet(forUid uid: String, completion: @escaping([Tweet]) -> Void) {
